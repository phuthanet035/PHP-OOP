-- ============================================================
-- SpaceHub Database Schema v3.0 - COMPLETE ALL-IN-ONE UTF8MB4 SAFE
...
-- STEP 0: สร้างฐานข้อมูล spacehub_db (ถ้าวิ่งใหม่จะลบเก่าออกก่อน)
DROP DATABASE IF EXISTS `spacehub_db`;
...
-- หมายเหตุ: เพิ่มสถานะ PENDING สำหรับระบบ Admin หลังบ้าน
...
('RM-101','Starlight Innovation Lab','Meeting Room',12,450.00,'["โปรเจคเตอร์ 4K","กระดานอัจฉริยะ (Smartboard)","ระบบ Video Conference","เครื่องชงกาแฟอัตโนมัติ"]','https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=800&q=80','ห้องประชุมนวัตกรรมพร้อมเทคโนโลยีระดับพรีเมียม รองรับการประชุมทั้งออนไซต์และไฮบริด',1),
...
VALUES
(1,'BK-2026-001','ศุภนัฐ จันทร์เปรม (รหัส 036)','081-234-5678','suppanat036@spacehub.com','ทีมพัฒนาแอป 036','ประชุมวางแผนโปรเจกต์ทีม 036','RM-101','2026-09-16','09:00:00','12:00:00',4,'["coffee","projector_4k"]','CONFIRMED',3.00,1350.00,830.00,152.60,2332.60,'2026-09-16 08:00:00','ขอปลั๊กไฟเพิ่ม 2 จุด (งาน 036)'),
(2,'BK-2026-002','สมาชิกทีมพัฒนา (รหัส 035)','089-876-5432','student035@spacehub.com','ทีมพัฒนาแอป 035','สัมมนาการเขียนโปรแกรม OOP 035','RM-102','2026-09-16','09:00:00','12:00:00',8,'["whiteboard_kit"]','CONFIRMED',3.00,1650.00,250.00,133.00,2033.00,'2026-09-16 09:30:00','ขอไมโครโฟนไร้สาย (งาน 035)'),
(3,'BK-2026-003','ศุภนัฐ จันทร์เปรม (รหัส 036)','081-234-5678','suppanat036@spacehub.com','ทีมพัฒนาแอป 036','เวิร์กชอป Mobile App Dev 036','RM-201','2026-09-16','09:00:00','12:00:00',15,'["coffee","sound_eng"]','CONFIRMED',3.00,2550.00,2400.00,346.50,5296.50,'2026-09-16 10:15:00','เตรียมเครื่องดื่มต้อนรับ (งาน 036)'),
(4,'BK-2026-004','สมาชิกทีมพัฒนา (รหัส 035)','089-876-5432','student035@spacehub.com','ทีมพัฒนาแอป 035','สอบสัมภาษณ์นักเรียนรหัส 035','RM-301','2026-09-16','09:00:00','12:00:00',5,'["sound_eng"]','CONFIRMED',3.00,1950.00,600.00,178.50,2728.50,'2026-09-16 11:00:00','เสร็จสิ้นเรียบร้อย (งาน 035)'),
(5,'BK-2026-005','ศุภนัฐ จันทร์เปรม (รหัส 036)','081-234-5678','suppanat036@spacehub.com','ทีมพัฒนาแอป 036','ถ่ายทำคลิปวิดีโอ 036 Studio','RM-501','2026-09-16','09:00:00','12:00:00',20,'["sound_eng"]','CONFIRMED',3.00,7500.00,600.00,567.00,8667.00,'2026-09-16 11:45:00','ต้องการไฟสปอร์ตไลท์เพิ่ม (งาน 036)'),
(6,'BK-2026-006','สมาชิกทีมพัฒนา (รหัส 035)','089-876-5432','student035@spacehub.com','ทีมพัฒนาแอป 035','อบรมการใช้งาน Database SQL 035','RM-302','2026-09-22','10:00:00','12:00:00',10,'["projector_4k"]','CONFIRMED',2.00,1160.00,350.00,105.70,1615.70,'2026-09-15 13:00:00','ขอสาย LAN 10 เส้น (งาน 035)'),
(7,'BK-2026-007','ศุภนัฐ จันทร์เปรม (รหัส 036)','081-234-5678','suppanat036@spacehub.com','ทีมพัฒนาแอป 036','Hackathon ทีม 036 Coding','RM-401','2026-09-23','08:00:00','17:00:00',20,'["coffee","projector_4k","sound_eng"]','PENDING',9.00,1800.00,3350.00,360.50,5510.50,'2026-09-16 08:30:00','รออนุมัติงบประมาณ (งาน 036)'),
(8,'BK-2026-008','สมาชิกทีมพัฒนา (รหัส 035)','089-876-5432','student035@spacehub.com','ทีมพัฒนาแอป 035','ติวข้อสอบวิชา Web Dev 035','RM-402','2026-09-23','13:00:00','17:00:00',6,'["whiteboard_kit"]','CONFIRMED',4.00,720.00,250.00,67.90,1037.90,'2026-09-16 09:10:00','เน้นแอร์เย็น (งาน 035)'),
(9,'BK-2026-009','ศุภนัฐ จันทร์เปรม (รหัส 036)','081-234-5678','suppanat036@spacehub.com','ทีมพัฒนาแอป 036','ประชุมบอร์ดบริหารโปรเจกต์ 036','RM-501','2026-09-24','11:00:00','14:00:00',10,'["coffee","sound_eng"]','CONFIRMED',3.00,7500.00,1800.00,651.00,9951.00,'2026-09-16 10:00:00','จัดชุดกาแฟ Coffee Break (งาน 036)'),
(10,'BK-2026-010','สมาชิกทีมพัฒนา (รหัส 035)','089-876-5432','student035@spacehub.com','ทีมพัฒนาแอป 035','ทดสอบระบบการจองห้อง 035','RM-502','2026-09-24','15:00:00','18:00:00',4,'[]','CANCELLED',3.00,3600.00,0.00,252.00,3852.00,'2026-09-16 10:20:00','ยกเลิกเนื่องจากติดภารกิจ (งาน 035)'),
(11,'BK-2026-011','ศุภนัฐ จันทร์เปรม (รหัส 036)','081-234-5678','suppanat036@spacehub.com','ทีมพัฒนาแอป 036','การอบรม UX UI Design 036','RM-601','2026-09-25','09:00:00','16:00:00',12,'["projector_4k","whiteboard_kit","coffee"]','CONFIRMED',7.00,840.00,2040.00,201.60,3081.60,'2026-09-16 11:00:00','ขอ Whiteboard ขนาดใหญ่ (งาน 036)'),
(12,'BK-2026-012','สมาชิกทีมพัฒนา (รหัส 035)','089-876-5432','student035@spacehub.com','ทีมพัฒนาแอป 035','สรุปผลงานประจำเดือน 035','RM-602','2026-09-25','13:00:00','15:00:00',5,'["projector_4k"]','CONFIRMED',2.00,200.00,350.00,38.50,588.50,'2026-09-16 11:30:00','ขอรีโมทนำเสนอ (งาน 035)'),
(13,'BK-2026-013','ศุภนัฐ จันทร์เปรม (รหัส 036)','081-234-5678','suppanat036@spacehub.com','ทีมพัฒนาแอป 036','บันทึกเสียง Podcast ทีม 036','RM-701','2026-09-26','10:00:00','13:00:00',3,'["sound_eng"]','CONFIRMED',3.00,2250.00,600.00,199.50,3049.50,'2026-09-16 12:00:00','ห้องเงียบเสียงพิเศษ (งาน 036)'),
(14,'BK-2026-014','สมาชิกทีมพัฒนา (รหัส 035)','089-876-5432','student035@spacehub.com','ทีมพัฒนาแอป 035','สาธิตซอฟต์แวร์ให้ลูกค้า 035','RM-702','2026-09-26','14:00:00','17:00:00',8,'["projector_4k"]','PENDING',3.00,2700.00,350.00,213.50,3263.50,'2026-09-16 13:15:00','รอการยืนยันจากลูกค้า (งาน 035)'),
(15,'BK-2026-015','ศุภนัฐ จันทร์เปรม (รหัส 036)','081-234-5678','suppanat036@spacehub.com','ทีมพัฒนาแอป 036','สัมมนา Cyber Security 036','RM-101','2026-09-27','09:00:00','12:00:00',18,'["coffee","sound_eng"]','CONFIRMED',3.00,1350.00,2760.00,287.70,4397.70,'2026-09-16 14:00:00','ขอเก้าอี้เสริม 5 ตัว (งาน 036)'),
(16,'BK-2026-016','สมาชิกทีมพัฒนา (รหัส 035)','089-876-5432','student035@spacehub.com','ทีมพัฒนาแอป 035','เวิร์กชอป Data Science 035','RM-102','2026-09-27','13:00:00','16:00:00',14,'["projector_4k"]','CONFIRMED',3.00,1650.00,350.00,140.00,2140.00,'2026-09-16 14:30:00','ปลั๊กพ่วงสำหรับโน้ตบุ๊ก (งาน 035)'),
(17,'BK-2026-017','ศุภนัฐ จันทร์เปรม (รหัส 036)','081-234-5678','suppanat036@spacehub.com','ทีมพัฒนาแอป 036','ระดมความคิดไอเดียธุรกิจ 036','RM-201','2026-09-28','10:00:00','12:00:00',6,'["whiteboard_kit"]','CONFIRMED',2.00,1700.00,250.00,136.50,2086.50,'2026-09-16 15:00:00','ปากกาเคมี กระดาษ Post-it (งาน 036)'),
(18,'BK-2026-018','สมาชิกทีมพัฒนา (รหัส 035)','089-876-5432','student035@spacehub.com','ทีมพัฒนาแอป 035','อบรม AI Machine Learning 035','RM-202','2026-09-28','14:00:00','18:00:00',25,'["projector_4k","sound_eng","coffee"]','CONFIRMED',4.00,4800.00,3950.00,612.50,9362.50,'2026-09-16 15:30:00','โปรเจคเตอร์ความละเอียดสูง 4K (งาน 035)'),
(19,'BK-2026-019','ศุภนัฐ จันทร์เปรม (รหัส 036)','081-234-5678','suppanat036@spacehub.com','ทีมพัฒนาแอป 036','การแข่งขัน E-Sports ทีม 036','RM-301','2026-09-29','09:00:00','17:00:00',16,'["sound_eng"]','CONFIRMED',8.00,5200.00,600.00,406.00,6206.00,'2026-09-16 16:00:00','อินเทอร์เน็ตความเร็วสูง gigabit (งาน 036)'),
(20,'BK-2026-020','สมาชิกทีมพัฒนา (รหัส 035)','089-876-5432','student035@spacehub.com','ทีมพัฒนาแอป 035','ฉลองความสำเร็จปิดโครงการ 035','RM-302','2026-09-29','11:00:00','14:00:00',10,'["coffee","sound_eng"]','CONFIRMED',3.00,1740.00,1800.00,247.80,3787.80,'2026-09-16 16:30:00','จัดเลี้ยงอาหารว่าง (งาน 035)')
ON DUPLICATE KEY UPDATE `booking_code`=VALUES(`booking_code`), `status`=VALUES(`status`);

-- ============================================================
-- END: spacehub_db Complete All-in-One v3.0
-- Login: admin/admin123 | suppanat036/1234 | student035/1234
-- ============================================================
